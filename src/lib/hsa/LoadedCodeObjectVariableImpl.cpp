//===-- LoadedCodeObjectVariableImpl.cpp ----------------------------------===//
...
///
/// \file
/// This file implements the \c hsa::LoadedCodeObjectVariableImpl class.
//===----------------------------------------------------------------------===//
#include "hsa/LoadedCodeObjectVariableImpl.hpp"
...
LoadedCodeObjectVariableImpl::create(hsa_loaded_code_object_s LCO,
