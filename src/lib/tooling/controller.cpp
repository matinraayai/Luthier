...
Controller::Controller()
  ...
  HsaInterceptor = new luthier::hsa::Interceptor();
  HipCompilerInterceptor = new luthier::hip::CompilerInterceptor();
  HipRuntimeInterceptor = new luthier::hip::RuntimeInterceptor();
}
