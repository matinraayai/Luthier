...
public:
  ...
  disassemble(const hsa::ExecutableSymbol &Symbol, bool includeDebugInfo);
...
private:
  ...
  liftFunction(const hsa::ExecutableSymbol &Symbol, LiftedRepresentation &LR,
               llvm::DenseMap<hsa::ExecutableSymbol, bool> &SymbolUsageMap, bool includeDebugInfo);
  ...
  llvm::DenseMap<hsa::ExecutableSymbol, std::unique_ptr<LiftedRepresentation>>
      LiftedKernelSymbols{};
...
public:
  ...
  lift(const hsa::ExecutableSymbol &Symbol, bool includeDebugInfo);
  ...
  /// \sa LiftedRepresentation
  llvm::Expected<const LiftedRepresentation &>
  lift(const hsa::Executable &Exec, bool includeDebugInfo);
