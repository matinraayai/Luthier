...
#ifndef CODEGEN_REGISTER_H
#define CODEGEN_REGISTER_H
...
class Register {
 ...
 public:
    ...
    static constexpr bool isStackSlot(unsigned Reg) { return MCRegister::isStackSlot(Reg); }
    ...
    static constexpr bool isPhysicalRegister(unsigned Reg) { return MCRegister::isPhysicalRegister(Reg); }

    /// Return true if the specified register number is in
    /// the virtual register namespace.
    static constexpr bool isVirtualRegister(unsigned Reg) { return Reg & MCRegister::VirtualRegFlag; }
    ...
    MCRegister asMCReg() const {
        assert(Reg == MCRegister::NoRegister || MCRegister::isPhysicalRegister(Reg));
    ...
    constexpr bool operator==(const Register &Other) const { return Reg == Other.Reg; }
    constexpr bool operator!=(const Register &Other) const { return Reg != Other.Reg; }
    constexpr bool operator==(const MCRegister &Other) const { return Reg == Other.id(); }
    constexpr bool operator!=(const MCRegister &Other) const { return Reg != Other.id(); }
    ...
    constexpr bool operator==(MCPhysReg Other) const { return Reg == unsigned(Other); }
    constexpr bool operator!=(MCPhysReg Other) const { return Reg != unsigned(Other); }
};
...
template <> struct DenseMapInfo<luthier::Register> {
    ...
    static unsigned getHashValue(const luthier::Register &Val) {
        return DenseMapInfo<unsigned>::getHashValue(Val.id());
    }
    static bool isEqual(const luthier::Register &LHS, const luthier::Register &RHS) {
