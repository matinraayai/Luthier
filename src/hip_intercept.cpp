...
extern "C" void __hipGetPCH(const char * * pch, unsigned int * size) {
	...
	hipCallback(static_cast<void*>(&hip_func_args), SIBIR_API_PHASE_ENTER, api_id);
	...
	// Exit Callback
	hipCallback(static_cast<void*>(&hip_func_args), SIBIR_API_PHASE_EXIT, api_id);
