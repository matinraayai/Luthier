...
enum hip_private_api_id_t {
    ...
    HIP_PRIVATE_API_ID_hipDrvGraphAddMemcpyNode = 1011,
    HIP_PRIVATE_API_ID_hipExtGetLastError = 1012,
    HIP_PRIVATE_API_ID_hipExternalMemoryGetMappedMipmappedArray = 1013,
    HIP_PRIVATE_API_ID_hipGetCmdName = 1014,
    HIP_PRIVATE_API_ID_hipGetErrorName = 1015,
    HIP_PRIVATE_API_ID_hipGetStreamDeviceId = 1016,
    HIP_PRIVATE_API_ID_hipKernelNameRef = 1017,
    HIP_PRIVATE_API_ID_hipKernelNameRefByPtr = 1018,
    HIP_PRIVATE_API_ID_hipLaunchKernel_common = 1019,
    HIP_PRIVATE_API_ID_hipLaunchKernel_spt = 1020,
    HIP_PRIVATE_API_ID_hip_init = 1021,
    HIP_PRIVATE_API_ID_hipModuleLaunchKernelExt = 1022,
    HIP_PRIVATE_API_ID_LAST = 1022
};
