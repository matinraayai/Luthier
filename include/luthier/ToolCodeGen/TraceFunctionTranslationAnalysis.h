//===-- TraceFunctionTranslationAnalysis.h ------------------------*-C++-*-===//
...
//===----------------------------------------------------------------------===//
/// \file TraceFunctionTranslationAnalysis.h
/// Describes the \c TraceFunctionTranslationAnalysis, a pinned \c
...
/// dirty blocks.
//===----------------------------------------------------------------------===//
#ifndef LUTHIER_TOOL_CODE_GEN_TRACE_FUNCTION_TRANSLATION_ANALYSIS_H
#define LUTHIER_TOOL_CODE_GEN_TRACE_FUNCTION_TRANSLATION_ANALYSIS_H
...
/// \brief Result of \c TraceFunctionTranslationAnalysis: owns the lifted IR of
/// a machine function and keeps it in sync with the MIR via re-translation of
/// dirty MBBs.
///
...
/// re-translation, so no client ever invokes the \c TraceFunctionTranslator
...
class TranslationState {
  friend class TraceFunctionTranslationAnalysis;
  ...
  /// re-translation
  std::unique_ptr<TraceFunctionTranslator> Translator;
  ...
  /// \c TraceFunctionTranslator::retranslateMBB; false when a structural change
...
class TraceFunctionTranslationAnalysis
    : public llvm::AnalysisInfoMixin<TraceFunctionTranslationAnalysis> {
  friend llvm::AnalysisInfoMixin<TraceFunctionTranslationAnalysis>;
