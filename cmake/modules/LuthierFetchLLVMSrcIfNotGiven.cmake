# If ${llvm_src_out} is not a valid directory, attempts to fetch the source code of the
# LLVM binary found by CMake by downloading it from the repo specified by its VCSRevision.h.
# In that scenario, ${llvm_src_out} will be set to the LLVM source code fetched by this
# function
function(luthier_fetch_llvm_src_if_not_given llvm_include_dirs llvm_src_out)
    if (NOT IS_DIRECTORY ${llvm_src_out})
        message(STATUS "LLVM source directory was not passed or is invalid; Trying to fetch it automatically")
